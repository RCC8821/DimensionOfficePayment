...
//   const grandTotal = selectedBills.reduce((sum, uid) => sum + (Number(paidAmounts[uid]) || 0), 0);
...
//               const netAmount = Number(bill.Amount || bill.TOTAL_AMOUNT_4 || bill.NET_AMOUNT_4 || 0);
//               const paid = Number(paidAmounts[bill.uid] || 0);
//               const balance = netAmount - paid;
//               const progressPct = netAmount > 0 ? Math.min((paid / netAmount) * 100, 100) : 0;
...
//                     {/* <InfoChip label="Basic Amt" value={bill.BASIC_AMOUNT ? `₹${fmt(bill.BASIC_AMOUNT)}` : null} /> */}
...
//                 ⚠️ Bank, Payment Mode, Details, and Date will be applied to <strong>all selected bills</strong>. Paid Amount and Remark are set per-bill above.
//               </div>
