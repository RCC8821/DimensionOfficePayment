...
// // POST: /api/dim-expenses-approved2
// export async function POST(request) {
//   try {
//     const body = await request.json();
//     console.log('Received body:', body); // Debug

//     const { uid, STATUS_3, PAYMENT_MODE_3, REMARK_3 } = body;
...
//     // Get all values from the Bill No column (B7:B)
//     const response = await sheets.spreadsheets.values.get({
//       spreadsheetId: spreadsheetId,
...
//     // Update STATUS_3 → AD, PAYMENT_MODE_3 → AF, REMARK_3 → AG
...
//     return NextResponse.json({
//       success: true,
//       message: 'Final approval updated',
//       row: sheetRowNumber,
//     });
//   } catch (error) {
