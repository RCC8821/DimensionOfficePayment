...
// // Uses its own ref — completely isolated from global mousedown handler
...
//               key={idx}
//               onMouseDown={(e) => {
//                 e.preventDefault(); // Key fix: prevent blur before click
//                 onSelect(opt);
//                 setOpen(false);
//               }}
//               style={{
...
//         formRaisedBy: selectedFormRaised, billPhoto: billPhoto || '',
//         remarks: i.remarks || ''
//       })),
//       remarks: ''
//     };
...
//       setPayeeName(''); setSelectedFormRaised(''); setFormRaisedSearch('');
//       setBillPhoto(''); setBillPhotoPreview('');
//       setItems([{ id: 1, subhead: '', subheadSearch: '', itemName: '', itemNameSearch: '', unit: '', skuCode: '', quantity: '', amount: '', remarks: '' }]);
//     } catch (err) {
...
//               <input type="file" accept="image/*" onChange={handleBillPhoto}
...
//                   <button type="button" onClick={() => { setBillPhoto(''); setBillPhotoPreview(''); }}
...
//             <div style={{ fontSize: '12px', fontWeight: '700', color: '#6366f1', textTransform: 'uppercase', letterSpacing: '0.08em', display: 'flex', alignItems: 'center', gap: '6px' }}>
//               <span>📦</span> Items Details
//             </div>
//             <button type="button" onClick={addItem}
//               style={{ background: 'linear-gradient(135deg,#10b981,#059669)', color: '#fff', border: 'none', borderRadius: '10px', padding: '9px 18px', fontSize: '13px', fontWeight: '700', cursor: 'pointer', boxShadow: '0 2px 8px rgba(16,185,129,0.25)', display: 'flex', alignItems: 'center', gap: '5px' }}
...
//             <div key={item.id} style={{ border: '1.5px solid #e0e7ff', borderRadius: '14px', padding: '20px', marginBottom: '16px', background: '#fafbff' }}>
...
//           {/* ── Total Box ── */}
//           <div style={{ background: 'linear-gradient(135deg,#f0f4ff,#faf5ff)', border: '1.5px solid #e0e7ff', borderRadius: '12px', padding: '16px 22px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
//             <div>
